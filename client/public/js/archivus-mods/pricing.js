const response = await fetch(
  'https://api.archivus.com/mods/token-plans',
  {
    method: 'GET',
    headers: {
  ...
  updatedPlans.forEach((plan) => {
    ...
    planButton.addEventListener('click', async function () {
      ...
      var options = {
        ...
        callback_url: `https://api.archivus.com/${data.verifyUrl}?frontendBase=https://archivus.com&successRedirect=/mods/success&failureRedirect=/mods/failure`,
