const response = await fetch('https://api.archivus.com/spaces/quotas', {
  method: 'GET',
  headers: {
...
window.onload = () => {
  ...
  updatedPlans.forEach((plan) => {
    ...
    planButton.addEventListener('click', async function () {
      ...
      var data = null;
      const baseUrl = 'https://api.archivus.com/billing/create';
      ...
      var options = {
        ...
        callback_url: `https://api.archivus.com/${data.verifyUrl}?frontendBase=https://archivus.com&successRedirect=/space/success&failureRedirect=/space/failure`,
